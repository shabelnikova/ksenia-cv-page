    ...
    return (
        <>
            ...
            <li className={styles.header_cv_container}>
                ...
                <a className={styles.header_cv} href={"CV_Ksenia_Shabelnikov_FrontEnd_Fullstack_Developer_Junior.pdf"} download={"CV_Ksenia_Shabelnikov_FrontEnd_Fullstack_Developer_Junior.pdf"}>{t("cv")}</a>
            </li>
        </>
    );
};
